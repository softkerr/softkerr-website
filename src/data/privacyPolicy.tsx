...
export const privacyPolicy = {
  ...
  content: [
    {
      title: 'Definitions',
      description: `"Controller" means the organization that determines the purposes and means of processing Personal Data. The Controller is SoftKerr, SL (Societat Limitada), registered address: Av. de les Nacions Unides, 40, 6-1, Edifici A Tower, Escala A, AD700 Escaldes-Engordany, Principat d’Andorra.
...
Your use of the Services is subject to this Privacy Policy; however, where consent is required by law (e.g., for cookies/marketing in the EEA/UK), we will request it separately and not rely on implied/blanket consent. If you do not agree with any of the terms of this Privacy Policy, please do not use our Services.`,
    },
    {
      ...
      description: `We may also use your contact information to send you marketing materials about our products, services, and promotions. If you do not wish to receive these materials, you can unsubscribe at any time by clicking the "unsubscribe" link in the email or by contacting us.`,
    },
    {
      title: 'Disclosure of Personal Data',
      listTitle: 'We may disclose your personal data to the following types of third parties:',
      ...
      description: `We do not sell, rent, or lease your personal data to third parties. In particular, we do not “sell” personal information as that term may be defined under applicable U.S. state privacy laws, and we do not “share” personal information for cross-context behavioral advertising without providing applicable opt-out or consent mechanisms.`,
    },
    {
      title: 'Third-Party Links',
      description: `Our Services may contain links to third-party websites, products, and services that are not owned or controlled by us. We are not responsible for the privacy practices or content of these third-party sites. We encourage you to review the privacy policies and terms of use of any third-party sites that you access.
...
We also engage processors and partners that may process personal data outside your jurisdiction (for example, in the European Union, the United States, and the United Arab Emirates). In such cases, we implement appropriate safeguards to ensure a level of protection essentially equivalent to that in the EEA/UK. These safeguards include:`,
    ...
    },
    {
      ...
      description: `Our Services are not directed to children under the age of 13, and we do not knowingly collect personal data from children under the age of 13. If you are under 13 years of age, do not use or provide any information on our Services or provide any personal data about yourself to us.
...
We also agree to the individual redress principle, which requires that individuals have a right to pursue legally enforceable rights against data Collectors and Processors who fail to adhere to the law. This principle requires not only that individuals have enforceable rights against data users, but also that individuals have recourse to courts or a government agency to investigate and / or prosecute non-compliance by Data Processors.`,
    ...
    {
      title: 'Contact Us',
      description: `If you have any questions or concerns about this Privacy Policy, please contact us email`,
    },
  ],
