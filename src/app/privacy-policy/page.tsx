...
export const metadata = {
  title: 'Privacy Policy - SoftKerr',
  description:
    'SoftKerr Privacy Policy - Learn how we collect, use, and protect your personal data.',
};
      ...
      <Container>
        <div className="mx-auto max-w-4xl">
          ...
          <div className="mb-12 text-center">
            ...
            <p className="text-sm text-text-secondary">{privacyPolicy.lastUpdated}</p>
          </div>
